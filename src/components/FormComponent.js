    ...
    <>
      ...
      <BackgroundBox clicked={click}>
        ...
        <Form className="signin">
          <Title>SIGN IN</Title>
          <Input type = "email" name = "email" id = "emailsigninId" placeholder = "Email" />
            <Input type = "password" name = "password" id = "passwordsigninId" placeholder = "Password" />
        ...
        <Form className="signup">
          <Title>SIGN UP</Title>
          <Input type = "text" name = "Username" id = "usernamesignupId" placeholder = "Username" />
            <Input type = "email" name = "email" id = "emailsignupId" placeholder = "Email" />
            <Input type = "password" name = "password" id = "passwordsignupId" placeholder = "Password" />
        ...
        <Text className="text1" clicked={click}>
          <h1>Welcome!</h1> Don't have an account?
          <br />
        ...
        <Text className="text2" clicked={click}>
          <h1>Hi There!</h1> Already have an account?
          <br />
          <span className="attention">Click on Emoji</span>
          <span className="attention-icon">⤷</span>
        </Text>
